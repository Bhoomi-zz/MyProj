...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#ContactPerson").autocomplete('<%= Url.Action("FindContactPerson" , "Shared" ) %>',
          {
              minChars: 1,
              delay: 400,
              cacheLength: 100,
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
           <%: Html.HiddenFor(model => model.BriefId)%>
            ...
            <tr>
                ...
                <td>Brief Date </td>
                <td>  <%: Html.EditorFor(model => model.BriefDate, new Dictionary<string, object>(){{"Title","DateTimePicker"}}) %> <em>*</em>
            ...
            <tr>
             ...
             <td>
                <%: Html.DropDownListFor(model => model.Customer, Model.Customers, "Select one..", new { id = "sContactId" })%> <em>*</em>
            ...
            <table style ="width:70%" class="TablePanel">
            <tr>            
                
                <td> <%: Html.LabelFor(model => model.TentativeStartDate) %> </td>
                <td style="text-align:left"><%: Html.EditorFor(model => model.TentativeStartDate, new Dictionary<string, object>() { { "Title", "DateTimePicker" } })%>
    ...
    <br />  <%: Html.ActionLink("Add New Brief", "Add")%>
</div>
</div>
</asp:Content>
