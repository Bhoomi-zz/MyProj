    ...
    public static class BootStrapper
    {
        public static void BootUp()
        {
            var config = new StructureMapConfiguration(cfg =>
            {
                ...
                //cfg.For<IEventBus>().Use(InitializeSaga);
        ...
        //private static IEventBus InitializeSaga()
        //{
        //    var bus = new InProcessEventBus();
        //    bus.RegisterAllSagaHandlersInAssembly(typeof(SagaHandlers.BriefSaga).Assembly);
        //    return bus;
        //}
    }
}