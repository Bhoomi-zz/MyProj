...
namespace Ncqrs.Commanding.CommandExecution.Mapping.Fluent
{
    ...
    public class MappedCommandToAggregateRoot<TCommand, TAggRoot> : MappedCommandToAggregateRoot<TCommand> where TCommand : ICommand where TAggRoot : AggregateRoot
    {
